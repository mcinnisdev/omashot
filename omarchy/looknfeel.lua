-- Omacut window rules, for ~/.config/hypr/looknfeel.lua.
--
...
-- for Omacut: its windows show screenshots you are about to mark up and
...
o.window("^omacut$", { tag = "-default-opacity", opacity = "1 1" })
