...
description: "Hand a Omashot bundle to an AI agent with the Write process doc prompt and your brand kit, so the process document it writes reads like it came from your company."
---
...
1. Put your logo, colours and voice notes in `~/Omashot/brand/`, once. Open **Hand off → Brand kit…** in the bundle window to write the notes: tone, audience, terminology, things never to say. They are saved as `brand/brand.md`.
...
- [Bundles for agents](/docs/omashot) and [Brand kit](/docs/brand-kit) in the docs.
